...
unsigned long LIGHT_ONOFF = 16648583;
unsigned long LIGHT_BRIGHT_PLUS = 16648579;
unsigned long LIGHT_BRIGHT_MINUS = 16648578;
    ...
    if (dist>0){
       ...
       if (dist < 20) {
          if (needChangeState) {
            ...
            //mySwitch.send(LIGHT_ONOFF, 24);
            send(msgDistance.set(dist, 1));
            needChangeState = false;
          }
         // needChangeState = (millis() - last_lock_time) < LOCK_TIME;  
        } 
